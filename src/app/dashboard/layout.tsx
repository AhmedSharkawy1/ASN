    ...
    const navSections: NavSection[] = [
        ...
        },
        {
            ...
            items: [
                ...
                ...(tenantTheme?.includes("vicino") ? [{ href: "/dashboard/theme-vicino", icon: Palette, labelAr: "تعديل الصفحة الرئيسية (Vicino)", labelEn: "Vicino Landing Page Settings", key: "theme_vicino" }] : []),
