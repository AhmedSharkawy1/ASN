...
interface Theme22MenuProps {
    config: RestaurantType;
    categories: CategoryWithItemsType[];
    restaurantId: string;
}

export default function Theme22Menu({ config, categories, restaurantId }: Theme22MenuProps) {
    ...
    const T22_PRIMARY = '#f97316'; // orange-500
    const primaryColor = config.theme_colors?.primary || T22_PRIMARY;
                                        ...
                                        >
                                            ...
                                            <div className={`flex flex-col flex-1 ${viewMode === 'list' ? 'py-1 pr-1' : 'p-3 pt-6'}`}>
                                                ...
                                                {config.orders_enabled !== false && (
                                                    <button
                                                        className="w-full mt-2.5 py-2 px-3 rounded-xl flex items-center justify-center gap-1.5 text-xs font-bold text-white shadow-sm transition-transform active:scale-95"
                                                    ...
                                                    <SwiperSlide key={idx}>
                                                        ...
                                                        >
                                                            <div className="relative h-[120px]">
                                                                ...
                                                                <button
                                                                    className="absolute bottom-2 left-2 right-2 py-1 px-2 rounded-lg flex items-center justify-center gap-1 text-[10px] font-bold text-white shadow-md backdrop-blur-sm"
                                                                    style={{ backgroundColor: primaryColor }}
                                                                    onClick={(e) => {
                                                                        e.stopPropagation();
                                                                        openModal(item, item.catName || '');
                                                                    }}
                                                                >
