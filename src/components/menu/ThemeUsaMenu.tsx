...
export default function ThemeUsaMenu({ config, categories, restaurantId }: ThemeUsaMenuProps) {
    ...
    const itemDesc = (item: MenuItem) => item.desc_en || item.description_en || item.details_en || item.description || item.desc || item.desc_ar || item.description_ar || item.details_ar || '';
