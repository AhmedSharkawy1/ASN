...
interface ThemeVicinoMenuProps {
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto pb-24">
                            ...
                            <div className="p-6 -mt-8 relative rounded-t-[2rem]" style={{ backgroundColor: bgBody }}>
                                ...
                                {config.orders_enabled !== false && (
                                    <div className="mb-8">
                                        <label className="block font-bold mb-2 text-sm text-slate-800 dark:text-zinc-200">{isAr ? 'ملاحظات (اختياري)' : 'Notes (Optional)'}</label>
                                        <textarea 
                                            value={notes}
                                            onChange={(e) => setNotes(e.target.value)}
                                            placeholder={isAr ? 'أضف ملاحظاتك هنا...' : 'Add your notes here...'}
                                            className="w-full h-24 p-4 rounded-2xl bg-black/5 dark:bg-white/5 border border-transparent focus:border-[#B8860B] focus:outline-none focus:ring-2 resize-none text-slate-900 dark:text-zinc-100"
