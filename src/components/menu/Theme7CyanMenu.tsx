...
/* ───── COMPONENT ───── */
export default function Theme7CyanMenu({ config, categories, restaurantId }: { config: any; categories: any[]; restaurantId: string }) {
        ...
        <div className="min-h-screen pb-20" dir="rtl"
            ...
            <div className="sticky top-0 z-[100] mt-6" style={{ backgroundColor: isDarkMode ? T7_BG : '#f8fafc' }}>
                ...
                <div ref={catNavRef}
                    ...
                    style={{ scrollbarWidth: 'none', borderColor: isDarkMode ? T7_BORDER : '#0891b2' }}>
                            ...
                            {section.items.filter((i: any) => i.is_available !== false).map((item: any) => (
                                <div key={item.id}
                                    ...
                                    style={{
                                        ...
                                        border: `1px solid ${isDarkMode ? T7_BORDER : '#0891b2'}`,
                                    }}>
                                                ...
                                                return (
                                                    <div key={pIdx}
                                                        ...
                                                        style={{
                                                            ...
                                                            border: `1px solid ${isDarkMode ? 'rgba(255,255,255,0.15)' : '#0891b2'}`,
                                                        }}>
                        ...
                        <motion.div initial={{ scale: 0.95, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.95, opacity: 0, y: 20 }}
                                        ...
                                        {selectedItem.item.prices.map((price: number, idx: number) => {
                                            ...
                                            return (
                                                <label key={idx}
                                                    ...
                                                    style={{
                                                        borderColor: sel ? T7_GOLD : (isDarkMode ? T7_BORDER : '#0891b2'),
                            ...
                            {config.orders_enabled !== false && (
                                <div className="p-4 flex items-center gap-4 shrink-0 border-t"
                                    style={{ borderColor: isDarkMode ? T7_BORDER : '#0891b2', background: isDarkMode ? T7_BG : '#fff' }}>
                ...
                {isCartOpen && (
                    <div className="fixed inset-0 z-[400] bg-black/50 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setIsCartOpen(false)}>
                        <motion.div initial={{ opacity: 0, scale: .95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: .95 }}
                            ...
                            onClick={e => e.stopPropagation()}>
                            {/* header */}
                            <div className="p-4 flex items-center justify-between shrink-0 border-b" style={{ borderColor: isDarkMode ? T7_BORDER : '#0891b2' }}>
                                        ...
                                        <div className="flex-1 flex flex-col gap-1">
                                            ...
                                            <div className="flex justify-between items-center mt-2">
                                                <div className="flex items-center justify-between rounded-lg p-1 w-24"
                                                    style={{ background: isDarkMode ? 'rgba(255,255,255,0.08)' : '#f1f5f9', border: `1px solid ${isDarkMode ? T7_BORDER : '#0891b2'}` }}>
                            ...
                            {config.orders_enabled !== false && cart.length > 0 && (
                                <div className="p-4 shrink-0 border-t" style={{ borderColor: isDarkMode ? T7_BORDER : '#0891b2' }}>
