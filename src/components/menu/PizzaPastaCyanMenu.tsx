                                ...
                                {showCallMenu && (
                                    <>
                                        ...
                                        <div className="absolute top-full mt-3 left-0 right-0 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 rounded-[1.5rem] shadow-2xl overflow-hidden animate-slideUp z-50">
                                            {config.phone && (
                                                <a href={`tel:${config.phone}`} className="flex items-center justify-between px-5 py-4 hover:bg-cyan-50 dark:hover:bg-cyan-500/5 border-b last:border-0 border-zinc-100 dark:border-white/5 transition-all group">
                                                    <span className="text-[10px] font-bold text-zinc-500 dark:text-zinc-400">{isAr ? "الرقم الأساسي" : "Main"}</span>
                                                    <span className="text-[15px] font-black tabular-nums text-cyan-600 dark:text-cyan-500 flex items-center gap-2" dir="ltr">
                                                        {config.phone} <span className="group-hover:animate-emoji text-xs">📞</span>
                                                    </span>
                                                </a>
                                            )}
                                            {config.phone_numbers?.map((pn, idx) => (
                                                <a key={idx} href={`tel:${pn.number}`} className="flex items-center justify-between px-5 py-4 hover:bg-cyan-50 dark:hover:bg-cyan-500/5 border-b last:border-0 border-zinc-100 dark:border-white/5 transition-all group">
                                                    ...
                                                    config.orders_enabled !== false ? (
                                                        <button
                                                            ...
                                                            className={`flex flex-col items-center gap-1 transition-all group/btn
                                                                ${hasManyPrices
                                                                    ? "bg-zinc-50 dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-2xl py-2 px-1 active:scale-95 hover:border-cyan-500/50"
                                                                    : "active:scale-90"
                                                                }`}
                                                        >
                                                            ...
                                                            <div className={`flex items-center justify-center gap-0.5
                                                                ${hasManyPrices ? "" : "bg-zinc-100 dark:bg-zinc-800/80 px-3 py-2 rounded-2xl border border-zinc-200 dark:border-white/5 hover:border-cyan-500/40 shadow-sm"}`}
                                                            >
                        ...
                        >
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        {(selectedItem.item.prices?.length > 0 ? selectedItem.item.prices : [0]).map((p, idx) => (
                                            <button
                                                ...
                                                className={`p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-1 ${tempSizeIdx === idx ? "border-cyan-600 bg-cyan-50 dark:bg-cyan-900/10" : "border-zinc-100 dark:border-white/5 bg-zinc-50 dark:bg-white/5"}`}
                                            >
                            ...
                            <div className="p-6 bg-zinc-50 dark:bg-white/5 border-t border-zinc-100 dark:border-white/5">
                                {config.orders_enabled !== false && (
                                    <button
                                        onClick={addToCart}
                                        className="w-full bg-cyan-600 text-white font-black py-4 rounded-2xl shadow-lg flex items-center justify-center gap-3 active:scale-95 transition-all text-base"
                                    >
                        ...
                        >
                            ...
                            <div className="p-6 border-t border-zinc-100 dark:border-white/5 bg-zinc-50 dark:bg-white/5">
                                ...
                                <button onClick={() => { setShowCart(false); setShowCheckout(true); }}
                                    className="w-full bg-cyan-600 text-white font-black py-4 rounded-2xl shadow-lg active:scale-95 transition-all text-base flex items-center justify-center gap-3">
