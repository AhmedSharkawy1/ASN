...
const T9_RED = '#ec4899'; // Pink/Rose color
...
interface Theme9PinkMenuProps {
    config: RestaurantType;
    categories: CategoryWithItemsType[];
    restaurantId: string;
}

export default function Theme9PinkMenu({ config, categories, restaurantId }: Theme9PinkMenuProps) {
