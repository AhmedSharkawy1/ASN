...
export default function Theme10SkyMenu({ config, categories, restaurantId }: Theme10MenuProps) {
    ...
    const bgBody = isDark ? '#0284c7' : '#f8fafc'; // slate-900 / slate-50
    const bgCard = isDark ? '#1e293b' : '#ffffff'; // slate-800 / white
    const textMain = isDark ? '#f1f5f9' : '#0284c7'; // slate-100 / slate-900
