                    ...
                    <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-8">
                        ...
                        <div className="flex gap-6">
                            ...
                            {config.whatsapp_number && (
                                <a href={`whatsapp://send?phone=${config.whatsapp_number.replace(/\+/g, "")}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white flex items-center justify-center hover:bg-white hover:text-[#059669] transition-colors">
