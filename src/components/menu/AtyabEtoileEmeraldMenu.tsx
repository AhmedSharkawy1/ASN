                ...
                <div className="max-w-4xl mx-auto px-4 py-3 md:py-4">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2 cursor-pointer group" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
                            {config.logo_url && (
                                <div className="w-10 h-10 md:w-12 md:h-12 relative flex items-center justify-center overflow-hidden rounded-full bg-[#FDFBF7] dark:bg-[#1E1E1E] shadow-sm border border-[#34d399] dark:border-[#333] p-1">
            ...
            <AnimatePresence>
                {showCategoriesMenu && (
                    ...
                    >
                        ...
                        >
                            <div className="p-6 text-center border-b border-[#34d399] dark:border-[#333]">
