...
// ================= THEME 13 CONSTANTS =================
// The template uses #0284c7 as the primary color.
const T13_PRIMARY = '#0284c7';
const T13_PRIMARY_LIGHT = '#38bdf8';
...
export default function Theme13SkyMenu({ config, categories, restaurantId }: Theme13MenuProps) {
                                                ...
                                                <div key={i} className="flex gap-3 p-3 rounded-xl bg-white dark:bg-[#1e1e1e] border shadow-sm" style={{ borderColor }}>
                                                    ...
                                                    <div className="flex-1 min-w-0 flex flex-col justify-between pt-1">
                                                        <div className="flex justify-between items-start gap-2">
                                                            ...
                                                            <button onClick={() => updateQty(c.id, c.notes, -c.quantity)} className="text-sky-400 hover:text-sky-600 transition-colors p-1 shrink-0">
                                                        ...
                                                        <div className="flex justify-between items-center mt-2">
                                                            ...
                                                            <div className="flex items-center bg-slate-100 dark:bg-slate-800 rounded px-1 py-0.5 border" style={{ borderColor }}>
                                                                <button onClick={() => updateQty(c.id, c.notes, -1)} className="w-6 h-6 flex items-center justify-center text-slate-500 hover:text-sky-500 rounded hover:bg-white dark:hover:bg-slate-700 transition-colors"><Minus className="w-3 h-3" /></button>
