...
// ================= THEME 13 CONSTANTS =================
// The template uses #dc2626 as the primary color.
const T13_PRIMARY = '#dc2626';
...
export default function Theme13RedMenu({ config, categories, restaurantId }: Theme13MenuProps) {
