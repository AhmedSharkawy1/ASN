 ...
 * Typography: Cairo.
 */
export default function BabAlHaraRedMenu({ config, categories, language, restaurantId }: Props) {
                                            ...
                                            {pm.number && (
                                                <div className="flex items-center justify-between bg-white dark:bg-black/20 px-3 py-2.5 rounded-xl mb-2 border border-zinc-100 dark:border-white/5 group">
                                                    <button
                                                        ...
                                                        className="text-[#dc2626] text-[10px] font-black uppercase bg-[#dc2626]/10 px-2 py-1 rounded-lg active:scale-95"
                                                    >
                                                        {isAr ? "نسخ" : "Copy"}
                                                    </button>
